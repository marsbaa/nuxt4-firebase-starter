...
- [ ] 1.2 Add `updateEvent()` action to [`app/stores/calendarEvents.ts`](app/stores/calendarEvents.ts) with support for series scope (this/future/all)
- [ ] 1.3 Add `deleteEvent()` action to [`app/stores/calendarEvents.ts`](app/stores/calendarEvents.ts) with support for series scope (this/future/all)
